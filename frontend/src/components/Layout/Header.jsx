...
const Header = ({ activeHeading }) => {
  ...
  const handleSearchChange = (e) => {
    ...
    const filterProduct = allProducts && allProducts.filter((product) =>
    ...
    <div className={`${styles.section}`}>
        <div className='hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between'>
          ...
          <div className='w-[50%] relative'>
            <input type="text" placeholder='Search Product...' value={searchTerm} onChange={handleSearchChange} className='h-[40px] w-full px-2 border-blue-600 border-[2px] rounded-md' />
                    ...
                    return (
                      <Link to={`/product/${i._id}`}>
                        <div className="w-full flex items-start-py-3">
                          <img src={`${api}${i.images[0]}`} alt="" className="w-[40px] mr-[10px]" />
                          <h1>{i.name}</h1>
                        </div>
                      </Link>
                    )
          ...
          <div className="flex">
            ...
            <div className={`${styles.noramlFlex}`}>
              <div className="relative cursor-pointer mr-[15px]">
                {isAuthenticated ? (
                  <Link to='/profile'>
                    <img src={`${api}${user.avatar}`} className='w-[40px] h-[40px] rounded-full' alt="" />
                  </Link>
                ) : (
                  <Link to='/login'>
